...
export function GameDetailModal({ game, open, onClose, selections, onToggleSelection }: GameDetailModalProps) {
  ...
  const isLoadingAny = loadingExtra || loadingOddsBlaze;
      ...
      <DialogContent className="max-w-md max-h-[90vh] p-0 gap-0">
        ...
        <ScrollArea className="max-h-[60vh]">
          <div className="p-4 space-y-6">
            ...
            {(hasMainMarkets || hasOddsBlazeMarkets) && (hasExtraMarkets || loadingExtra) && (
              <div className="flex items-center gap-3 py-2">
                <div className="flex-1 h-px bg-border" />
            ...
            {!hasMainMarkets && !hasExtraMarkets && !hasOddsBlazeMarkets && !isLoadingAny && (
