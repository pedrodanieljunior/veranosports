          ...
          {!loading && !user ? (
            <>
              <button
                ...
                className="px-4 py-2 rounded-lg bg-white/30 border border-white/60 text-gray-900 font-bold text-sm shadow-sm hover:bg-white/50 transition-colors"
              ...
              <button
                onClick={onOpenLogin}
                className="px-4 py-2 rounded-lg bg-gray-900 text-white font-bold text-sm shadow-md hover:bg-gray-800 transition-colors"
