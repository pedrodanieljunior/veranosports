                ...
                <button
                  ...
                  className={`relative flex flex-col items-center px-3 py-1.5 rounded-lg border text-xs font-bold transition-colors min-w-[60px] ${
                    isSuspended
                      ...
                      : movement === "up"
                      ? active ? "bg-yellow-400 border-green-400 text-black" : "border-green-500/60 bg-gray-700 text-white"
                      : movement === "down"
                      ? active ? "bg-yellow-400 border-red-400 text-black" : "border-red-500/60 bg-gray-700 text-white"
                      : active
