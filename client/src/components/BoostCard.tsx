...
export function BoostCard({ card, selections, onToggleSelection }: BoostCardProps) {
  ...
  const cardStyle = {
    ...
    border: isAnySelected ? "2px solid #93c5fd" : "2px solid #3b82f6",
    boxShadow: isAnySelected
      ? "0 0 0 1px #93c5fd40, 0 6px 24px #2563eb50"
      : "0 3px 16px rgba(0,0,0,0.4), 0 0 0 1px #3b82f630",
  };
            ...
            {card.outcomes.map((o, idx) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: isChosen ? "#1d4ed840" : "linear-gradient(135deg, #dbeafe 0%, #eff6ff 100%)",
                    border: isChosen ? "1.5px solid #93c5fd" : "1px solid #bfdbfe",
                    cursor: "pointer",
                  }}
                >
