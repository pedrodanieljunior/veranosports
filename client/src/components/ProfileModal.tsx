                ...
                const TIERS = [
                  {
                    ...
                    dotReached: "bg-purple-500 border-purple-400",
                  ...
                  },
                  {
                    ...
                    dot: "bg-indigo-800 border-indigo-700",
                    dotReached: "bg-indigo-400 border-indigo-300",
                    card: "bg-indigo-950/40 border-indigo-800/50",
                    cardReached: "bg-indigo-900/40 border-indigo-500/70",
                    name: "text-indigo-600",
                    nameReached: "text-indigo-300",
                    bonus: "text-indigo-700",
                    bonusReached: "text-indigo-300",
                  },
                  {
                    label: "Ouro",
                    icon: "🥇",
                    glow: "rgba(59,130,246,0.45)",
                    dot: "bg-blue-800 border-blue-700",
                    dotReached: "bg-blue-400 border-blue-300",
                    card: "bg-blue-950/40 border-blue-800/50",
                    cardReached: "bg-blue-900/40 border-blue-500/70",
                    name: "text-blue-600",
                    nameReached: "text-blue-300",
                    bonus: "text-blue-700",
                    bonusReached: "text-blue-300",
                  },
                  {
                    label: "Diamante",
                    icon: "💎",
