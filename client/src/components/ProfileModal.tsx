                ...
                const TIERS = [
                  {
                    ...
                    nameReached: "text-orange-200",
                    bonus: "text-orange-300",
                    bonusReached: "text-orange-200",
                  },
                  {
                    label: "Prata",
                    icon: "🥈",
                    ...
                    name: "text-lime-300",
                    nameReached: "text-lime-200",
                    bonus: "text-lime-300",
                    bonusReached: "text-lime-200",
                  },
                  {
                    label: "Ouro",
                    icon: "🥇",
                    ...
                    nameReached: "text-purple-200",
                    bonus: "text-purple-300",
                    bonusReached: "text-purple-200",
                  },
                  {
                    label: "Diamante",
                    icon: "💎",
                    ...
                    name: "text-cyan-300",
                    nameReached: "text-cyan-200",
                    bonus: "text-cyan-300",
                    bonusReached: "text-cyan-200",
                  },
                ];
