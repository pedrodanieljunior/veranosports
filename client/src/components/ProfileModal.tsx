                ...
                return (
                  <div className="bg-zinc-800 rounded-xl p-4 border border-zinc-600/40" data-testid="card-clube-fw">
                    ...
                    <div className="relative h-2 bg-zinc-700 rounded-full mb-4">
                      <div
                        className="absolute inset-y-0 left-0 rounded-full transition-all duration-500 bg-yellow-400"
                        style={{ width: `${pct}%` }}
                      />
                        ...
                        <div className="grid grid-cols-4 gap-1 mb-3">
                          {CLUB_FW_LEVELS.map(({ level, threshold, bonus }, idx) => {
                            ...
                            return (
                              ...
                              >
                                {isPast && (
                                  <div className="absolute inset-0 flex items-center justify-center rounded-lg bg-zinc-900/50">
                                    <span className="text-zinc-300 font-bold text-sm">✓</span>
                                  </div>
                                )}
                                <p className="text-sm leading-none mb-0.5">{t.icon}</p>
                                <p className={`text-[9px] font-bold ${isCurrent ? "text-yellow-400" : "text-zinc-500"}`}>
                                  {t.label}
                                </p>
