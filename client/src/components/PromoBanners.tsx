...
function RotatingBanner({ images, interval = 4000, objectFit = "cover" }: { images: string[]; interval?: number; objectFit?: string }) {
...
export function PromoBanners() {
  return (
    <div className="flex gap-3 w-full max-w-[85%] mx-auto mr-8">
      ...
      <div className="flex-1">
        <RotatingBanner images={[banner2a, banner2b]} interval={5000} objectFit="contain" />
      </div>
    </div>
  );
}
