...
function RotatingBanner({ images, interval = 4000, objectPosition = "center" }: { images: string[]; interval?: number; objectPosition?: string }) {
...
export function PromoBanners() {
  return (
    <div className="flex gap-3 w-full max-w-[600px] mx-auto mr-8">
